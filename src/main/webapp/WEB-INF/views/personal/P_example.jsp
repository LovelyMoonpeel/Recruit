...
<hr class="line form-group" style="border: solid 0.5px #ccc; width:100%;" id="3">
   ...
   var uploadedList = document.getElementById('uploadedList');
	...
	$("#edu_div").on("click", ".edu_minus_btn", function(){
		 ...
		 if(edu_index!=0){
			 ...
			 $(this).closest('.line form-group').remove();
			 ...
			 console.log($(this).closest('.line').val()+"$(this).closest('.line').val()");
			 console.log($(this).closest('hr').val()+"$(this).closest('hr').val()");
