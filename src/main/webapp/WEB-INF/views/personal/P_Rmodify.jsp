...
<form role ="form" method="post">
  ...
  <div class="form-group">
    ...
    <!--  input type="file" class="form-control" id="img" value="${ResumeVO.img}">-->
     <input type="text" class="form-control" id="img" name="img" value="${ResumeVO.img}">
  </div>
 ...
 <div class="form-group">
   ...
   <input class="form-control" id="jobstateid" name="jobstateid" value="${ResumeVO.jobstateid}"></input>
 </div>
 <div class="form-group">
 ...
 <div class="form-group">
   ...
   <input class="form-control" id="rgbid" name="rgbid" value="${ResumeVO.rgbid}"></input>
 </div>
  <div class="form-group">
   <label for="rgsid">rgsid 희망 근무지(시/도)</label>
   <input class="form-control" id="rgsid" name="rgsid" value="${ResumeVO.rgsid}"></input>
 </div>
 <div class="form-group">
 ...
 <div class="form-group">
   ...
   <input class="form-control" id="salaryid" name = "salaryid" value="${ResumeVO.salaryid}"></input>
 </div>
