...
$(document).ready(function(){
	...
	var urlName = document.URL.substring(document.URL.lastIndexOf("/") + 1, document.URL.lastIndexOf("?"));

	$("div[name='stateHide']").prop("value",urlName);
	
	if($("div[name='stateHide']").val()!="C_recruitMent"){
		$("div[name='stateHide'] > *").remove();
	}
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" name="stateHide">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="#questionCall" style="color:white;"><span class="glyphicon glyphicon-user"></span> 질문하기</a></li>
				</ul>
