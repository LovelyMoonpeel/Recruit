...
<div class="col-md-9">
	...
	<form role="form" method="POST">
		...
		<p class="lead">
			<strong>채용공고 수정</strong>
		</p>
		<div class="form-group">
			<label>타이틀</label> <input type="text" name="title" class="form-control" id="" value="${RecruitVO.title}">
		</div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.12.4/js/bootstrap-select.min.js"></script>
			...
			<tr>
				...
				<td>
					<input type="text" name="recruitnum" value="${RecruitVO.recruitnum }">명
				</td>
			</tr>
			<tr>
